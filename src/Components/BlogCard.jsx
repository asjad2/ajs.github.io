...
function Blog({ item },props) {
  ...
  return (
    <section className={`bg-${props.bgcolor} text-${props.headtxtcolor}  mx-auto body-font  py-4`}>
    <div className="container mx-auto ">
      <div className="p-8 h-fit  lg:h-[30rem]  bg-[#7ff0ce] rounded-3xl">
        <span
